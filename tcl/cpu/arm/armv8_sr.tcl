...
proc get_sr_encoding {sys_reg_name} {
	...
	switch $sys_reg_name {
		...
		ERXSTATUSR_EL1 {set sr_encoding {3 0 5 4 2}}
		...
		ERXPFGF_EL1 {set sr_encoding {3 0 15 2 0}}
		ERXPFGCTLR_EL1 {set sr_encoding {3 0 15 2 1}}
		ERXPFGCDNR_EL1 {set sr_encoding {3 0 15 2 2}}
		CNTPCT_EL0 {set sr_encoding {3 3 14 0 1}}
		CNTP_TVAL_EL1 {set sr_encoding {3 3 14 2 0}}
		CNTP_CVAL_EL1 {set sr_encoding {3 3 14 2 2}}
